...
class CartPole():
    def __init__(self, hiddenLayerPolicy: List[int], hiddenLayerValue: List[int], AlphaTheta=1e-4, AlphaW=1e-4):
        self.G = 9.8
        self.MC = 1.0  # Mcart
        self.MP = 0.1  # Mport
...
if __name__ == '__main__':
    ...
    D,A = CartPole.train()
    with open(r"C:\Users\fulian\Desktop\Final_project\One Step Actor Critic\A_Cart.pkl", 'wb') as f:
        pickle.dump(A, f)
    with open(r"C:\Users\fulian\Desktop\Final_project\One Step Actor Critic\A_Cart.pkl", 'rb') as f:  # 'rb'表示以二进制模式读取文件
